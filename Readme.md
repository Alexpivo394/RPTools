...
Скачайте готовый установщик (MSI) из раздела [Releases](https://github.com/Alexpivo394/RPTools/releases), запустите его и закройте Revit на время установки. После установки инструменты появятся на ленте Revit во вкладке **RPTools**.
