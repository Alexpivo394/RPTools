...
**ToadTools** — это набор инструментов (плагинов) для Autodesk Revit, который автоматизирует рутинные задачи проектировщиков и BIM-специалистов: заполнение и проверку параметров, создание рабочих наборов и пространств, работу с кабельными лотками, теплопотерями, армированием и многое другое.

Все инструменты собираются на отдельной ленте **ToadTools** прямо в интерфейсе Revit. Изначально проект создавался для внутренних нужд компании, но может быть полезен любому, кто работает в Revit.

### 📖 Документация для пользователей

Подробные инструкции по каждому инструменту (что делает, как пользоваться, со скриншотами) — в **[Wiki проекта](https://github.com/Alexpivo394/RPTools/wiki)**.

### Что входит в набор

| Раздел ленты | Инструменты |
|---|---|
| **BIM** | ParamChecker, Создание рабочих наборов, Копирование элементов, Проверка рабочих наборов, Замена общих семейств |
| **Лотки** | Кабельные лотки (артикулы, покраска), Разместить крышки |
| **Общие** | Длина элементов, Создание пространств, Записать количество, Записать прочерк |
| **Сети связи** | Структурная схема |
| **ОВ** | Синхронизация теплопотерь |
| **АР** | Открывание дверей, Основание отделки |
| **КР** | Армирование по цвету |

### Установка (для пользователей)

Скачайте готовый установщик (MSI) из раздела [Releases](https://github.com/Alexpivo394/RPTools/releases), запустите его и закройте Revit на время установки. После установки инструменты появятся на ленте Revit во вкладке **ToadTools**.

> [!NOTE]
> Часть инструментов использует общие файлы с сетевого диска компании (семейства, шаблоны, Excel-таблицы). Если вы работаете вне корпоративной сети, такие файлы нужно получить отдельно — это отмечено на странице соответствующего инструмента в Wiki.

---

## Для разработчиков

Autodesk Revit plugin project organized into multiple solution files that target versions 2020 - 2027.
