...
> [!NOTE]
> Часть инструментов использует общие файлы с сетевого диска компании (семейства, шаблоны, Excel-таблицы). Если вы работаете вне корпоративной сети, такие файлы нужно получить отдельно — они лежат в папке assets.
