...
Все инструменты собираются на отдельной ленте **RPTools** прямо в интерфейсе Revit. Изначально проект создавался для внутренних нужд компании, но может быть полезен любому, кто работает в Revit.
