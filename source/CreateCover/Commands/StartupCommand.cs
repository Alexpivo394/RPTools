...
public class StartupCommand : IExternalCommand
{
    ...
    private const string FamilyPath = @"Y:\12-BIM\Стандарт\Общие семейства и мануалы ко всем шаблонам\Семейства ЭОМ, СС\Соединители лотка\RP_Крышка.rfa";
    ...
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        var paramCreator = new ParamModelCreator(familyService.GetOrLoadFamilySymbol(), getFirstTrayService.GetFirstTray(), paramService);
